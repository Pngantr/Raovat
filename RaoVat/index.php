            ...
            <div class="flex-col show-for-medium flex-right">
              <ul class="mobile-nav nav nav-right ">
                <li class="cart-item has-icon">
                  <div class="header-button"> <a href="http://chotot.giaodienwebmau.com/gio-hang/" class="header-cart-link off-canvas-toggle nav-top-link icon button circle is-outline is-small" data-open="#cart-popup" data-class="off-canvas-cart" title="Giỏ hàng" data-pos="right">
                    </a>
                  </div>
                  <!-- Cart Sidebar Popup -->
                ...
                <li class="header-search-form search-form html relative has-icon">
                  <div class="header-search-form-wrapper">
                    <div class="searchform-wrapper ux-search-box relative form-flat is-normal">
                      <form role="search" method="get" class="searchform" action="http://chotot.giaodienwebmau.com/">
            ...
            <div class="flex-col hide-for-medium flex-right flex-grow">
              <ul class="nav header-nav header-bottom-nav nav-right  nav-uppercase">
                <li class="account-item has-icon">
                  <a href="signup.php" class="nav-top-link nav-top-not-logged-in ">
                    <span>
                      Đăng kí tài khoản </span>
                  </a>
                </li>
                <li class="account-item has-icon">
                  <a href="login.php" class="nav-top-link nav-top-not-logged-in ">
                    <span>
                      Đăng nhập </span>
                  </a>
                </li>
